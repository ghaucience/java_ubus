...
bool list_search(stList_t *l, void *data) {
  ASSERT(l != NULL);
  ASSERT(data != NULL);
...
void list_remove(stList_t *l, void *data) {
  ASSERT(l != NULL);
  ASSERT(data != NULL);
...
void* list_search_compare(stList_t *l, int (*cmp)(void *,void*), void *data) {
  ASSERT(l != NULL);
  ASSERT(data != NULL);
	ASSERT(cmp != NULL);
